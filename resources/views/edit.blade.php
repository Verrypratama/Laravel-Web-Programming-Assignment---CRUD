            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="/editData" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- hidden id -->
                        <input type="hidden" class="form-control" id="id" name="id" value="{{ $id }}" aria-describedby="emailHelp">
                        <!-- end hidden id -->
                        <!-- form text field -->
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="namadaerah" name="namadaerah" value="{{ $data->namadaerah }}" aria-describedby="emailHelp">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="foto" name="foto" value="{{ $data->foto }}" aria-describedby="emailHelp">
